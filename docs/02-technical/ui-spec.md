...
- [Swaralipi — UI Specification](#swaralipi--ui-specification)
  - [Table of Contents](#table-of-contents)
  - [1. Overview](#1-overview)
    - [1.1 Purpose](#11-purpose)
    - [1.2 Related Documents](#12-related-documents)
    - [1.3 How to Read](#13-how-to-read)
  - [2. Design System — Material 3](#2-design-system--material-3)
    - [2.1 ThemeData Configuration](#21-themedata-configuration)
      - [2.1.1 Dynamic Color (Monet)](#211-dynamic-color-monet)
      - [2.1.2 Default Seed Colors](#212-default-seed-colors)
    - [2.2 Color System](#22-color-system)
      - [2.2.1 Color Role Assignments](#221-color-role-assignments)
      - [2.2.2 Catppuccin Palette — In-App Usage](#222-catppuccin-palette--in-app-usage)
        - [Catppuccin Mocha Colors (Dark Mode Swatches)](#catppuccin-mocha-colors-dark-mode-swatches)
        - [Catppuccin Latte Colors (Light Mode Swatches)](#catppuccin-latte-colors-light-mode-swatches)
    - [2.3 Typography Scale](#23-typography-scale)
    - [2.4 Shape Tokens](#24-shape-tokens)
    - [2.5 Elevation](#25-elevation)
    - [2.6 Motion \& Transitions](#26-motion--transitions)
      - [2.6.1 Screen Transitions (go\_router)](#261-screen-transitions-go_router)
      - [2.6.2 Component Motion](#262-component-motion)
  - [3. Global Shell](#3-global-shell)
    - [3.1 Bottom Navigation Bar](#31-bottom-navigation-bar)
    - [3.2 App Bar Patterns](#32-app-bar-patterns)
    - [3.3 FAB](#33-fab)
  - [4. Screens](#4-screens)
    - [4.1 Library — Home Screen](#41-library--home-screen)
      - [4.1.1 Layout Structure](#411-layout-structure)
      - [4.1.2 Header](#412-header)
      - [4.1.3 Recently Played Carousel](#413-recently-played-carousel)
      - [4.1.4 Notation List](#414-notation-list)
      - [4.1.5 Search Bar](#415-search-bar)
      - [4.1.6 Sort Control](#416-sort-control)
      - [4.1.7 Tag Chip Quick-Filter Row](#417-tag-chip-quick-filter-row)
      - [4.1.8 Advanced Filter Drawer](#418-advanced-filter-drawer)
      - [4.1.9 Swipe Actions](#419-swipe-actions)
      - [4.1.10 Context Menu (Long Press)](#4110-context-menu-long-press)
      - [4.1.11 Empty States](#4111-empty-states)
    - [4.2 Notation Detail View](#42-notation-detail-view)
      - [4.2.1 Layout](#421-layout)
      - [4.2.2 Fanned Paper Stack](#422-fanned-paper-stack)
      - [4.2.3 Metadata Block](#423-metadata-block)
      - [4.2.4 Play Button](#424-play-button)
    - [4.3 Notation Player](#43-notation-player)
      - [4.3.1 Layout](#431-layout)
      - [4.3.2 Chrome Fade](#432-chrome-fade)
      - [4.3.3 Top Overlay](#433-top-overlay)
      - [4.3.4 Bottom Overlay](#434-bottom-overlay)
      - [4.3.5 Orientation Lock](#435-orientation-lock)
    - [4.4 Capture Entry Bottom Sheet](#44-capture-entry-bottom-sheet)
    - [4.5 Camera Selection Screen](#45-camera-selection-screen)
      - [4.5.1 Layout](#451-layout)
      - [4.5.2 Photo Select Cell](#452-photo-select-cell)
      - [4.5.3 Empty State](#453-empty-state)
    - [4.6 Page Editor](#46-page-editor)
      - [4.6.1 Layout](#461-layout)
      - [4.6.2 Active Page Preview](#462-active-page-preview)
        - [Filter ColorMatrix Values](#filter-colormatrix-values)
      - [4.6.3 Per-Page Toolbar](#463-per-page-toolbar)
      - [4.6.4 Thumbnail Strip](#464-thumbnail-strip)
      - [4.6.5 Filter Picker Sheet](#465-filter-picker-sheet)
      - [4.6.6 Crop UI](#466-crop-ui)
      - [4.6.7 Discard Confirmation](#467-discard-confirmation)
    - [4.7 Metadata Form](#47-metadata-form)
      - [4.7.1 Layout](#471-layout)
      - [4.7.2 Field Specifications](#472-field-specifications)
        - [Custom Field Inputs by Type](#custom-field-inputs-by-type)
      - [4.7.3 Save Gate](#473-save-gate)
    - [4.8 Settings Screen](#48-settings-screen)
      - [4.8.1 Layout](#481-layout)
      - [4.8.2 Row Specifications](#482-row-specifications)
      - [4.8.3 Your Name Dialog](#483-your-name-dialog)
    - [4.9 Appearance \& Theming](#49-appearance--theming)
      - [4.9.1 Layout](#491-layout)
      - [4.9.2 Theme Mode Toggle](#492-theme-mode-toggle)
      - [4.9.3 Catppuccin Swatch Picker](#493-catppuccin-swatch-picker)
    - [4.10 Tags](#410-tags)
      - [4.10.1 Tag List](#4101-tag-list)
        - [TagListRow Widget](#taglistrow-widget)
        - [Pre-seeded Tags](#pre-seeded-tags)
      - [4.10.2 Tag Form](#4102-tag-form)
      - [4.10.3 Delete Tag Confirmation](#4103-delete-tag-confirmation)
    - [4.11 Instruments](#411-instruments)
      - [4.11.1 Instrument List](#4111-instrument-list)
        - [InstrumentInstanceRow](#instrumentinstancerow)
      - [4.11.2 Instrument Class Form](#4112-instrument-class-form)
      - [4.11.3 Instrument Instance Form](#4113-instrument-instance-form)
        - [PhotoPickerCard](#photopickercard)
      - [4.11.4 Instrument Instance Detail](#4114-instrument-instance-detail)
        - [DetailRow Widget](#detailrow-widget)
      - [4.11.5 Archive Confirmation](#4115-archive-confirmation)
    - [4.12 Trash](#412-trash)
      - [4.12.1 Layout](#4121-layout)
      - [4.12.2 TrashNotationRow](#4122-trashnotationrow)
      - [4.12.3 Empty State](#4123-empty-state)
      - [4.12.4 Confirmation Dialogs](#4124-confirmation-dialogs)
    - [4.13 Custom Fields](#413-custom-fields)
      - [4.13.1 Layout](#4131-layout)
      - [4.13.2 CustomFieldRow](#4132-customfieldrow)
      - [4.13.3 Create/Edit Custom Field Sheet](#4133-createedit-custom-field-sheet)
      - [4.13.4 Delete Confirmation](#4134-delete-confirmation)
  - [5. Component Patterns](#5-component-patterns)
    - [5.1 Catppuccin Color Picker](#51-catppuccin-color-picker)
    - [5.2 Chip Input Field](#52-chip-input-field)
    - [5.3 Notation Card (Recently Played Carousel)](#53-notation-card-recently-played-carousel)
    - [5.4 Notation Row (Library List)](#54-notation-row-library-list)
    - [5.5 Fanned Paper Stack](#55-fanned-paper-stack)
    - [5.6 Tag Chip (Display)](#56-tag-chip-display)
    - [5.7 Error States](#57-error-states)
      - [Screen-Level Error](#screen-level-error)
      - [Inline Error (Form)](#inline-error-form)
      - [Error Snackbar](#error-snackbar)
    - [5.8 Empty States](#58-empty-states)
    - [5.9 Snackbar Patterns](#59-snackbar-patterns)
    - [5.10 Dialog Patterns](#510-dialog-patterns)
    - [5.11 Bottom Sheet Patterns](#511-bottom-sheet-patterns)
  - [6. Accessibility](#6-accessibility)
    - [6.1 Contrast Requirements](#61-contrast-requirements)
    - [6.2 Touch Targets](#62-touch-targets)
    - [6.3 Semantics Labels](#63-semantics-labels)
    - [6.4 TalkBack-Specific Implementation](#64-talkback-specific-implementation)
  - [7. Orientation \& Layout](#7-orientation--layout)
    - [7.1 Portrait (Primary)](#71-portrait-primary)
    - [7.2 Landscape — Player](#72-landscape--player)
    - [7.3 Orientation Lock (Player)](#73-orientation-lock-player)
    - [7.4 Safe Areas](#74-safe-areas)
